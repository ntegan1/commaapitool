...
transcode_frame_x="$((transcode_frame_scale * framew))"
transcode_frame_x=$((transcode_frame_x))
transcode_frame_y="$((transcode_frame_scale * frameh))"
transcode_frame_y=$((transcode_frame_y))
